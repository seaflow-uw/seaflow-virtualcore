...
#
#
#   poly.fsc <- c(0,ref.fsc, break.fsc,break.fsc,80000,80000)
#   poly.d1 <- c(intersect.small.d1,
#                 intersect.small.d1 +  notch.small.D1* ref.fsc,
#                 intersect.small.d1 +  notch.small.D1* break.fsc,
#                 intersect.large.d1 +  notch.large.D1* break.fsc,
#                 intersect.large.d1 +  notch.large.D1*80000,
#                 intersect.small.d1)
#
#   poly.d2 <- c(intersect.small.d2,
#                 intersect.small.d2 +  notch.small.D2* ref.fsc,
#                 intersect.small.d2 +  notch.small.D2* break.fsc,
#                 intersect.large.d2 +  notch.large.D2* break.fsc,
#                 intersect.large.d2 +  notch.large.D2*80000,
#                 intersect.small.d2)
#   poly.d1_97.5 <- c(intersect.small.d1_97.5,
#                 intersect.small.d1_97.5 +  notch.small.D1_97.5* ref.fsc,
#                 intersect.small.d1_97.5 +  notch.small.D1_97.5* break.fsc,
#                 intersect.large.d1_97.5 +  notch.large.D1_97.5* break.fsc,
#                 intersect.large.d1_97.5 +  notch.large.D1_97.5*80000,
#                 intersect.small.d1_97.5)
#
#   poly.d2_97.5 <- c(intersect.small.d2_97.5,
#                 intersect.small.d2_97.5 +  notch.small.D2_97.5* ref.fsc,
#                 intersect.small.d2_97.5 +  notch.small.D2_97.5* break.fsc,
#                 intersect.large.d2_97.5 +  notch.large.D2_97.5* break.fsc,
#                 intersect.large.d2_97.5 +  notch.large.D2_97.5*80000,
#                 intersect.small.d2_97.5)
#
#   poly.d1_2.5 <- c(intersect.small.d1_2.5,
#                 intersect.small.d1_2.5 +  notch.small.D1_2.5* ref.fsc,
#                 intersect.small.d1_2.5 +  notch.small.D1_2.5* break.fsc,
#                 intersect.large.d1_2.5 +  notch.large.D1_2.5* break.fsc,
#                 intersect.large.d1_2.5 +  notch.large.D1_2.5*80000,
#                 intersect.small.d1_2.5)
#
#   poly.d2_2.5 <- c(intersect.small.d2_2.5,
#                 intersect.small.d2_2.5 +  notch.small.D2_2.5* ref.fsc,
#                 intersect.small.d2_2.5 +  notch.small.D2_2.5* break.fsc,
#                 intersect.large.d2_2.5 +  notch.large.D2_2.5* break.fsc,
#                 intersect.large.d2_2.5 +  notch.large.D2_2.5*80000,
#                 intersect.small.d2_2.5)
#
#     poly.opp.filtration <- data.frame(fsc_small = poly.fsc, D1=round(poly.d1), D2=round(poly.d2),
#                             D1high=round(poly.d1_97.5), D2high=round(poly.d2_97.5),
#                             D1low=round(poly.d1_2.5), D2low=round(poly.d2_2.5))
#
#     plot(DF$fsc, DF$d1, xlim=c(0,65000), ylim=c(0,65000),main=paste(ins))
#       points(df.c$fsc.med+comp.fsc,df.c$d1.med+comp.d1, col=2)
#       points(ref.o$fsc.med, ref.o$d1.med, pch=16)
#       points(ref.c$fsc.med+comp.fsc, ref.c$d1.med+comp.d1, col=2,pch=16)
#       polygon(poly.opp.filtration[,c(1,2)])
#       polygon(poly.opp.filtration[,c(1,4)],border='grey')
#       polygon(poly.opp.filtration[,c(1,6)],border='grey')
#
#     plot(DF$fsc, DF$d2, xlim=c(0,65000), ylim=c(0,65000),main=paste(ins))
#       points(df.c$fsc.med+comp.fsc,df.c$d2.med+comp.d2, col=2)
#       points(ref.o$fsc.med, ref.o$d2.med, pch=16)
#       points(ref.c$fsc.med+comp.fsc, ref.c$d2.med+comp.d2, col=2,pch=16)
#         polygon(poly.opp.filtration[,c(1,3)])
#       polygon(poly.opp.filtration[,c(1,5)],border='grey')
#       polygon(poly.opp.filtration[,c(1,7)],border='grey')
# }
# dev.off()
#
# write.csv(POLY, "/1.bead_calibration/seaflow_filter_MERGED_Poly.csv", quote=F, row.names=F)
