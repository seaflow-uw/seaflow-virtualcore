...
if(inst == 740){
  list <- list[-14]
  notch.small.D1 <-  0.75 # 0.656
  notch.small.D2 <-  0.75 # 0.683
  notch.large.D1 <- 1.56 # 1.635
  notch.large.D2 <- 2.05 # 1.632
  pe.lim.o <- 50000
  fsc.lim.o <- 45000
  pe.lim.c <- 35000
  fsc.lim.c <- 40000
...
if(inst == 751){
  list <- list[-14]
  notch.small.D1 <- 0.73 # 0.642
  notch.small.D2 <- 0.625 # 0.639
  notch.large.D1 <- 1.6 # 1.910
  notch.large.D2 <- 2.45 # 2.040
  pe.lim.o <- 55000
  fsc.lim.o <- 50000
  pe.lim.c <- 10000
  fsc.lim.c <- 37500
...
if(inst == 989){
  list <- list[-c(15:16)]
  notch.small.D1 <-  0.83 # 0.658
  notch.small.D2 <-  0.89 # 0.657
  notch.large.D1 <- 1.615 # 1.370
  notch.large.D2 <- 1.70 # 1.337
  pe.lim.o <- 50000
  fsc.lim.o <- 45000
  pe.lim.c <- 35000
  fsc.lim.c <- 35000
